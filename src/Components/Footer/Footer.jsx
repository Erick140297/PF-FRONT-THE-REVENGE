            ...
            <div className="row footer">
              <div className="col-md-1 mb-md-0 mb-3 marcas">
                ...
                <ul className="list-unstyled lista">
                  ...
                  <li>
                    <a
                      href="https://www.logitech.com/es-roam"
                      target="_blank"
                      rel="noopener noregerrer"
                    >
                      <Button variant="outline-info">
              ...
              <div className="col-md-5 mt-md-0 mt-4 leyenda">
                ...
                <p>
                  ...
                  gran gama de perrifericos para asegurar una experiencia comoda
                  y los respectivos equipos de mantenimiento para que puedas
                  cuidar de tu preciada reliquia
                </p>
              </div>
            </div>
          </div>
